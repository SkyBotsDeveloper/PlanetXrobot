...
from PLANETXROBOT.utils.database import get_served_chats, get_served_users, get_sudoers
from PLANETXROBOT.utils.decorators.language import language, languageCB
from PLANETXROBOT.utils.inline.stats import back_stats_buttons, stats_buttons
...
async def _mongo_stats_report():
    ...
    lines = [
        "📊 ᴍᴏɴɢᴏ sᴛᴀᴛs ʀᴇᴘᴏʀᴛ",
        "",
        f"ᴅᴀᴛᴀʙᴀsᴇ: {escape(str(stats.get('db', 'Planetx')))}",
