...
from PLANETXROBOT import app, YouTube
from config import (
    BANNED_USERS,
...
from PLANETXROBOT.utils.formatters import convert_bytes, time_to_seconds
from PLANETXROBOT.utils.inline.song import song_markup
...
async def _download_audio_with_ytdlp(vidid: str, title: str) -> tuple[str | None, str | None]:
    temp_dir = tempfile.mkdtemp(prefix="planetx_song_")
