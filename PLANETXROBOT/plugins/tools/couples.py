...
from PLANETXROBOT.core.dir import COUPLE_DIR
from PLANETXROBOT.mongo.couples_db import get_couple, save_couple


ASSETS = Path("PLANETXROBOT/assets")
...
async def generate_image(chat_id: int, uid1: int, uid2: int, date: str) -> str:
    base = Image.open(ASSETS / "planetx/couple.png").convert("RGBA")
