...
from PLANETXROBOT import LOGGER, YouTube, app
from PLANETXROBOT.misc import db
...
from PLANETXROBOT.utils.formatters import check_duration, seconds_to_min, speed_converter
from PLANETXROBOT.utils.inline.play import stream_markup
from PLANETXROBOT.security import build_subprocess_env
from PLANETXROBOT.utils.stream.autoclear import auto_clean
from PLANETXROBOT.utils.stream.autodelete import (
    delete_queue_message,
    remember_player_message,
)
from PLANETXROBOT.utils.stream.cards import schedule_stream_card
from PLANETXROBOT.utils.stream.precache import schedule_youtube_precache_for_chat
from PLANETXROBOT.utils.errors import capture_internal_err, send_large_error
...
class Call:
    ...
    def _ignored_vc_user_ids() -> set[int]:
        ignored = set()
        try:
            from PLANETXROBOT.core.userbot import assistantids
