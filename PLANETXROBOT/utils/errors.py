...
from PLANETXROBOT.utils.exceptions import AssistantErr, is_ignored_error
from PLANETXROBOT.utils.pastebin import PLANETXBIN
from PLANETXROBOT.security import redact_secrets
...
async def send_large_error(text: str, caption: str, filename: str):
    ...
    try:
        paste_url = await PLANETXBIN(text)
        if paste_url:
