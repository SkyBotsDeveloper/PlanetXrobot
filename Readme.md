...
<div align="center">
  <table>
    <tr>
      <td align="center">
        <img src="https://files.catbox.moe/ygblam.png" width="90px" style="border-radius: 50%;" />
      </td>
      <td>
        <img src="https://readme-typing-svg.herokuapp.com?color=00BFFF&width=600&lines=Hey+There,+This+is+SkyBotsDeveloper+%F0%9F%A5%80+%E2%9D%97%EF%B8%8F" />
      </td>
    </tr>
  </table>
</div>
...
<p align="center">
  <a href="https://t.me/Planetx_music">
    <img src="https://files.catbox.moe/dh6tpz.png" width="600">
  </a>
</p>

<p align="center">
  <a href="https://t.me/PlanetXrobot"><img src="https://img.shields.io/badge/Try%20Bot-@PlanetXrobot-blue?style=for-the-badge&logo=telegram"/></a>
</p>


<p align="center">
  <a href="https://github.com/SkyBotsDeveloper/PlanetXrobot/stargazers"><img src="https://img.shields.io/github/stars/SkyBotsDeveloper/PlanetXrobot?style=flat-square"/></a>
  <a href="https://github.com/SkyBotsDeveloper/PlanetXrobot/network/members"><img src="https://img.shields.io/github/forks/SkyBotsDeveloper/PlanetXrobot?style=flat-square"/></a>
  <a href="https://github.com/SkyBotsDeveloper/PlanetXrobot/issues"><img src="https://img.shields.io/github/issues/SkyBotsDeveloper/PlanetXrobot?style=flat-square"/></a>
  <a href="https://github.com/SkyBotsDeveloper/PlanetXrobot/commits/main"><img src="https://img.shields.io/github/last-commit/SkyBotsDeveloper/PlanetXrobot?style=flat-square"/></a>
  <a href="https://github.com/SkyBotsDeveloper/PlanetXrobot/actions"><img src="https://img.shields.io/badge/CI-Status-grey?style=flat-square"/></a>
</p>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          ...
          3) Get ID via <code>@PlanetXrobot</code> or <code>@MissRose_Bot</code>
        </td>
...
### Step 2: Clone Repo
git clone https://github.com/SkyBotsDeveloper/PlanetXrobot
cd PlanetXrobot
tmux new -s Planetx
...
tmux attach-session -t Planetx # Attach to Running Bot session
tmux kill-session -t Planetx # to kill the running bot session
rm -rf PlanetXrobot # Uninstall the repo
```
...
### Step 3: Build Image
docker build -t PlanetXrobot .

### Step 4: Run Container
docker run -d --name planetx --env-file .env --restart unless-stopped PlanetXrobot

### Step 5: Manage Container
docker logs -f planetx        # View logs (Ctrl+C to exit)
docker stop planetx           # Stop container
docker start planetx          # Start again
docker rm -f planetx          # Remove container
docker rmi PlanetXrobot      # Remove image
```
...
| 🌍 **Heroku Deploy**    | <a href="http://dashboard.heroku.com/new?template=https://github.com/SkyBotsDeveloper/PlanetXrobot"><img src="https://img.shields.io/badge/Deploy%20to-Heroku-purple?style=for-the-badge&logo=heroku"/></a> |
...
<p align="center">
  ...
  <a href="mailto:SkyBotsDeveloper@gmail.com">
...
* <b> *sᴩᴇᴄɪᴀʟ ᴛʜᴀɴᴋs ᴛᴏ <a href="https://github.com/CertifiedCoders">ᴄᴇʀᴛɪꜰɪᴇᴅᴄᴏᴅᴇʀꜱ</a> ғᴏʀ <a href="https://github.com/CertifiedCoders/AnnieXMusic">ᴀɴɴɪᴇxᴍᴜsɪᴄ</a>* </b>
* <b> *ᴄʀᴀғᴛᴇᴅ ᴡɪᴛʜ ᴘᴀssɪᴏɴ ʙʏ <a href="https://github.com/SkyBotsDeveloper">ᴅᴇᴠ</a>* </b>
